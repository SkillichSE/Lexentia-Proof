...
class LexSidebar extends HTMLElement {
  connectedCallback() {
    ...
    // Auth widget at the very bottom, outside nav
    html += `
      <div id="sidebar-auth-widget" class="sidebar-auth-widget">
        <div class="sidebar-auth-title">author account</div>
        <div id="sidebar-auth-status" class="sidebar-auth-status">not signed in</div>
        <button id="sidebar-auth-login" class="btn btn-sm sidebar-auth-btn">sign in github</button>
        <button id="sidebar-auth-logout" class="btn btn-sm btn-ghost sidebar-auth-btn" style="display:none;">sign out</button>
      </div>`;
